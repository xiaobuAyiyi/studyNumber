...
cc.Class({
    ...
    properties: {
        ...
        backGame: {
            ...
            tooltip: '返回当前所在游戏，点击关闭游戏结束界面，重新开始当场游戏',
        },
    ...
    _onNextGame() {
        ...
        //隐藏当前游戏节点并且显示下一个游戏节点
        if(smartFox.gameType === 'xxl') {
            EventBus.emit(Event.event.xxlNext);
        }
        else if(smartFox.gameType === 'ssg') {
            EventBus.emit(Event.event.ssgNext);
        }
        else if(smartFox.gameType === 'fsz') {
